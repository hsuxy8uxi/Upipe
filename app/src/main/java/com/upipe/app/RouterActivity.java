...
import com.upipe.app.databinding.ListRadioIconItemBinding;
import com.upipe.app.databinding.SingleChoiceDialogViewBinding;
import com.upipe.app.download.DownloadDialog;
import com.upipe.app.download.LoadingDialog;
...
import com.upipe.app.player.playqueue.ChannelTabPlayQueue;
import com.upipe.app.player.playqueue.PlayQueue;
import com.upipe.app.player.playqueue.PlaylistPlayQueue;
import com.upipe.app.player.playqueue.SinglePlayQueue;
import com.upipe.app.util.ChannelTabHelper;
...
import com.upipe.app.util.urlfinder.UrlFinder;
    ...
    public static class FetcherService extends IntentService {
        ...
        private NotificationCompat.Builder createNotification() {
            return new NotificationCompat.Builder(this, getString(R.string.notification_channel_id))
                    .setOngoing(true)
                    .setSmallIcon(R.drawable.ic_upipe_triangle_white)
