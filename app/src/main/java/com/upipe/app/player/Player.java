...
import static com.upipe.app.player.helper.PlayerHelper.retrievePlaybackParametersFromPrefs;
import static com.upipe.app.player.helper.PlayerHelper.retrieveSeekDurationFromPreferences;
import static com.upipe.app.player.helper.PlayerHelper.savePlaybackParametersToPrefs;
import static com.upipe.app.player.notification.NotificationConstants.ACTION_CLOSE;
import static com.upipe.app.player.notification.NotificationConstants.ACTION_FAST_FORWARD;
import static com.upipe.app.player.notification.NotificationConstants.ACTION_FAST_REWIND;
import static com.upipe.app.player.notification.NotificationConstants.ACTION_PLAY_NEXT;
import static com.upipe.app.player.notification.NotificationConstants.ACTION_PLAY_PAUSE;
import static com.upipe.app.player.notification.NotificationConstants.ACTION_PLAY_PREVIOUS;
import static com.upipe.app.player.notification.NotificationConstants.ACTION_RECREATE_NOTIFICATION;
import static com.upipe.app.player.notification.NotificationConstants.ACTION_REPEAT;
import static com.upipe.app.player.notification.NotificationConstants.ACTION_SHUFFLE;
import static com.upipe.app.util.ListHelper.getPopupResolutionIndex;
import static com.upipe.app.util.ListHelper.getResolutionIndex;
...
import com.upipe.app.databinding.PlayerBinding;
import com.upipe.app.error.ErrorInfo;
import com.upipe.app.error.ErrorUtil;
...
import com.upipe.app.fragments.detail.VideoDetailFragment;
import com.upipe.app.local.history.HistoryRecordManager;
import com.upipe.app.player.event.PlayerEventListener;
import com.upipe.app.player.event.PlayerServiceEventListener;
import com.upipe.app.player.helper.AudioReactor;
import com.upipe.app.player.helper.CustomRenderersFactory;
import com.upipe.app.player.helper.LoadController;
import com.upipe.app.player.helper.PlayerDataSource;
import com.upipe.app.player.helper.PlayerHelper;
import com.upipe.app.player.mediaitem.MediaItemTag;
import com.upipe.app.player.mediasession.MediaSessionPlayerUi;
import com.upipe.app.player.notification.NotificationPlayerUi;
import com.upipe.app.player.playback.MediaSourceManager;
import com.upipe.app.player.playback.PlaybackListener;
import com.upipe.app.player.playqueue.PlayQueue;
import com.upipe.app.player.playqueue.PlayQueueItem;
import com.upipe.app.player.playqueue.SinglePlayQueue;
import com.upipe.app.player.resolver.AudioPlaybackResolver;
import com.upipe.app.player.resolver.VideoPlaybackResolver;
import com.upipe.app.player.resolver.VideoPlaybackResolver.SourceType;
import com.upipe.app.player.ui.BackgroundPlayerUi;
import com.upipe.app.player.ui.MainPlayerUi;
import com.upipe.app.player.ui.PlayerUi;
import com.upipe.app.player.ui.PlayerUiList;
import com.upipe.app.player.ui.PopupPlayerUi;
import com.upipe.app.player.ui.VideoPlayerUi;
import com.upipe.app.util.DependentPreferenceHelper;
import com.upipe.app.util.ExtractorHelper;
import com.upipe.app.util.ListHelper;
import com.upipe.app.util.NavigationHelper;
import com.upipe.app.util.SerializedCache;
