...
import static com.upipe.app.player.Player.RENDERER_UNAVAILABLE;
import static com.upipe.app.player.Player.STATE_BUFFERING;
import static com.upipe.app.player.Player.STATE_COMPLETED;
import static com.upipe.app.player.Player.STATE_PAUSED;
import static com.upipe.app.player.Player.STATE_PAUSED_SEEK;
import static com.upipe.app.player.Player.STATE_PLAYING;
import static com.upipe.app.player.helper.PlayerHelper.formatSpeed;
import static com.upipe.app.player.helper.PlayerHelper.getTimeString;
import static com.upipe.app.player.helper.PlayerHelper.nextResizeModeAndSaveToPrefs;
...
import com.upipe.app.player.gesture.DisplayPortion;
import com.upipe.app.player.helper.PlayerHelper;
import com.upipe.app.player.mediaitem.MediaItemTag;
import com.upipe.app.player.playback.SurfaceHolderCallback;
import com.upipe.app.player.playqueue.PlayQueue;
import com.upipe.app.player.playqueue.PlayQueueItem;
import com.upipe.app.player.seekbarpreview.SeekbarPreviewThumbnailHelper;
import com.upipe.app.player.seekbarpreview.SeekbarPreviewThumbnailHolder;
...
import com.upipe.app.views.player.PlayerFastSeekOverlay;
    ...
    public boolean onKeyDown(final int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_CENTER:
                ...
                if (player.getCurrentState() == com.upipe.app.player.Player.STATE_BLOCKED) {
                    return true;
                }
