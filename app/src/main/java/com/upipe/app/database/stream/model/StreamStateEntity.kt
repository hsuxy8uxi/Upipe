...
package com.upipe.app.database.stream.model

import androidx.room.ColumnInfo
import androidx.room.Entity
import androidx.room.ForeignKey
import androidx.room.ForeignKey.Companion.CASCADE
import com.upipe.app.database.stream.model.StreamEntity.Companion.STREAM_ID
import com.upipe.app.database.stream.model.StreamStateEntity.Companion.JOIN_STREAM_ID
import com.upipe.app.database.stream.model.StreamStateEntity.Companion.PLAYBACK_FINISHED_END_MILLISECONDS
import com.upipe.app.database.stream.model.StreamStateEntity.Companion.STREAM_STATE_TABLE
...
data class StreamStateEntity(
    ...
    companion object {
         ...
         * (60000ms = 60s).
         * @see com.upipe.app.database.stream.model.StreamStateEntity.isFinished
         */
