...
class NewVersionWorker(
    ...
    private fun compareAppVersionAndShowNotification(
        ...
        val notificationBuilder = NotificationCompat.Builder(applicationContext, channelId)
            .setSmallIcon(R.drawable.ic_upipe_update)
    ...
    private fun checkNewVersion() {
        ...
        // Upipe does not have a release API yet. Keep update checks disabled until
        // a fork-owned endpoint exists instead of pointing users at upstream APKs.
        return
