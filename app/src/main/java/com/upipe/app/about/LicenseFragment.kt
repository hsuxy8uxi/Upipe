...
import com.upipe.app.databinding.FragmentLicensesBinding
import com.upipe.app.databinding.ItemSoftwareComponentBinding
import com.upipe.app.ktx.parcelableArrayList
...
class LicenseFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.licensesAppReadLicense.setOnClickListener {
            compositeDisposable.add(
                showLicense(UPIPE_SOFTWARE_COMPONENT)
            )
        }
        ...
        return if (context == null) {
            ...
            Observable.fromCallable { getFormattedLicense(context, softwareComponent.license) }
                ...
                .subscribe { formattedLicense ->
                    ...
                    if (softwareComponent != UPIPE_SOFTWARE_COMPONENT) {
    ...
    companion object {
        ...
        private val UPIPE_SOFTWARE_COMPONENT = SoftwareComponent(
            "Upipe",
            "2026",
            "hsuxy8uxi",
