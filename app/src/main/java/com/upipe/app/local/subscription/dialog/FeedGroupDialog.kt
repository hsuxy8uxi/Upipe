package com.upipe.app.local.subscription.dialog
...
import com.upipe.app.databinding.DialogFeedGroupCreateBinding
import com.upipe.app.databinding.ToolbarSearchLayoutBinding
import com.upipe.app.fragments.BackPressable
import com.upipe.app.local.subscription.FeedGroupIcon
import com.upipe.app.local.subscription.dialog.FeedGroupDialog.ScreenState.DeleteScreen
import com.upipe.app.local.subscription.dialog.FeedGroupDialog.ScreenState.IconPickerScreen
import com.upipe.app.local.subscription.dialog.FeedGroupDialog.ScreenState.InitialScreen
import com.upipe.app.local.subscription.dialog.FeedGroupDialog.ScreenState.SubscriptionsPickerScreen
import com.upipe.app.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.ProcessingEvent
import com.upipe.app.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.SuccessEvent
import com.upipe.app.local.subscription.item.ImportSubscriptionsHintPlaceholderItem
import com.upipe.app.local.subscription.item.PickerIconItem
import com.upipe.app.local.subscription.item.PickerSubscriptionItem
