package com.upipe.app.local.dialog;

import static com.upipe.app.database.playlist.model.PlaylistEntity.DEFAULT_THUMBNAIL_ID;
...
import com.upipe.app.local.LocalItemListAdapter;
