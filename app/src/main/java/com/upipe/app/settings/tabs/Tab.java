...
import com.upipe.app.database.LocalItem.LocalItemType;
...
import com.upipe.app.util.KioskTranslator;
...
public abstract class Tab {
    ...
    public static class LibraryTab extends Tab {
        ...
        @Override
        public String getTabName(final Context context) {
            return context.getString(R.string.tab_library);
        }
        ...
        @Override
        public LibraryFragment getFragment(final Context context) {
