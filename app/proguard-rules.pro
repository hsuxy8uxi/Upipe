...
-keep class com.upipe.app.settings.notifications.** { *; }
...
-keep,includedescriptorclasses class com.upipe.app.**$$serializer { *; }
-keepclassmembers class com.upipe.app.** {
    *** Companion;
}
-keepclasseswithmembers class com.upipe.app.** {
    kotlinx.serialization.KSerializer serializer(...);
}
